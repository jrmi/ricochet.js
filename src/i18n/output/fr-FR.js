;(function() {
  ...
  var localizations = {
    'fr-FR': {
      ...
      '__longFormats__latn': [{"threshold":1000,"formats":[{"pluralForm":"one","format":"{0} millier","decimalPattern":"0"},{"pluralForm":"other","format":"{0} mille","decimalPattern":"0"}]},{"threshold":10000,"formats":[{"pluralForm":"one","format":"{0} mille","decimalPattern":"00"},{"pluralForm":"other","format":"{0} mille","decimalPattern":"00"}]},{"threshold":100000,"formats":[{"pluralForm":"one","format":"{0} mille","decimalPattern":"000"},{"pluralForm":"other","format":"{0} mille","decimalPattern":"000"}]},{"threshold":1000000,"formats":[{"pluralForm":"one","format":"{0} million","decimalPattern":"0"},{"pluralForm":"other","format":"{0} millions","decimalPattern":"0"}]},{"threshold":10000000,"formats":[{"pluralForm":"one","format":"{0} million","decimalPattern":"00"},{"pluralForm":"other","format":"{0} millions","decimalPattern":"00"}]},{"threshold":100000000,"formats":[{"pluralForm":"one","format":"{0} million","decimalPattern":"000"},{"pluralForm":"other","format":"{0} millions","decimalPattern":"000"}]},{"threshold":1000000000,"formats":[{"pluralForm":"one","format":"{0} milliard","decimalPattern":"0"},{"pluralForm":"other","format":"{0} milliards","decimalPattern":"0"}]},{"threshold":10000000000,"formats":[{"pluralForm":"one","format":"{0} milliard","decimalPattern":"00"},{"pluralForm":"other","format":"{0} milliards","decimalPattern":"00"}]},{"threshold":100000000000,"formats":[{"pluralForm":"one","format":"{0} milliard","decimalPattern":"000"},{"pluralForm":"other","format":"{0} milliards","decimalPattern":"000"}]},{"threshold":1000000000000,"formats":[{"pluralForm":"one","format":"{0} billion","decimalPattern":"0"},{"pluralForm":"other","format":"{0} billions","decimalPattern":"0"}]},{"threshold":10000000000000,"formats":[{"pluralForm":"one","format":"{0} billion","decimalPattern":"00"},{"pluralForm":"other","format":"{0} billions","decimalPattern":"00"}]},{"threshold":100000000000000,"formats":[{"pluralForm":"one","format":"{0} billion","decimalPattern":"000"},{"pluralForm":"other","format":"{0} billions","decimalPattern":"000"}]}],
      ...
      'Auth mail html message': function(it) {
        var string = '';
        string += '<p>Bonjour,<p>\n\n<p>Voici le lien qui vous permet de vous connecter à ';
        string += it.siteName;
        string += ' :</p>\n\n<a ref="';
        string += it.url;
        string += '">';
      ...
      'Auth mail text_message': function(it) {
        var string = '';
        string += 'Bonjour,\n\nVoici le lien qui vous permet de vous connecter à ';
        string += it.siteName;
        string += ' :\n\n';
        string += it.url;
      ...
      'Your authentication link': function(it) {
        var string = '';
        string += '[';
        string += it.siteName;
        string += '] Votre lien d\'authentification';
        return string;
      }
    }
  };
  ...
  function l(key) {
    if(!(key in localizations['fr-FR'])) {
      throw new TypeError('Key `' + key + '` not in fr-FR localizations');
    }
    return localizations['fr-FR'][key].call(localizations['fr-FR'], arguments[1]);
  }
